 ...
 *         &lt;element name="repositoryURI" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class DataRepositoryType {
    ...
    @XmlElement(required = true)
    protected List<String> repositoryURI;
     ...
     * This is why there is not a <CODE>set</CODE> method for the repositoryURI property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getRepositoryURI().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<String> getRepositoryURI() {
        if (repositoryURI == null) {
            repositoryURI = new ArrayList<String>();
        }
